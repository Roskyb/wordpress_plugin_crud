...
class Comentarios
{
    ...
    public function run()
    {
        ...
        // plugin_base_name(__FILE__) to get recu_imaw_plantilla/comentarios.php
        add_filter('plugin_action_links_' . 'recu_imaw_plantilla/comentarios.php', [$this, 'add_action_links']);
        $this->gc_shortcode();
        $this->gc_widget();
    }
    ...
    {
        //__() function receives a string and return a translation if exists
        $mylinks = array(
            '   <a href="' . admin_url('options-general.php?page=gestion-comentarios-configuracion') . '">
                    '. __('Settings').' 
                </a>',
        );
...
?>
        <div class="wrap">
            ...
            <form action="options.php" method="post">
                ...
                ?>
                <input type="text" name="_comentarios_bg_color" class="my-color-field" <?php echo "value='$actual_color'" ?>>
                <br>
